...
#define USBTENKI_CHIP_INA226_BUS_VOLTAGE		0x13
#define USBTENKI_CHIP_INA226_SHUNT_VOLTAGE		0x14
#define USBTENKI_CHIP_INA226_POWER				0x15
#define USBTENKI_CHIP_INA226_CURRENT			0x16
